<!--  HTML dizesine bir göz atın. Buradaki görevinizin bir kısmı Html'i JSX'e "çevirmektir". Yüzeyde HTML ve JSX oldukça benzerdir, bu nedenle yapmanız gereken yalnızca bazı küçük değişiklikler vardır. İstenilen format için public içerisindeki preview.png dosyasına bakabilirsiniz
